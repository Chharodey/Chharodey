COLORS={'Olive':'#808000', 'Green':'#008000', 'Grey':'#808080', 'Aqua':'#00FFFF', 'Silver':'#C0C0C0' ,
        'Brown':'#C45824', 'Scarlet':'#FF0000', 'Blue':'#4b0082', 'White':'#FFFFFF'}
...
all_building={'Ферма':[STANDART, 'Добывает из клетки\n прирост еды', 3, 0, 0, 0, 0, 0], 'Лесоруб':[STANDART, 'Добывает из клетки\nприрост дерева', 2, 0, 0, 0, 0, 2], 'Карьер':[['Лес', 'Горы', 'Луг', 'Холм', 'Река'], 'Добывает из клетки прирост\nкамня и глины', 2, 0, 0, 0, 0, 4],
              ...
              'Прииск':[STANDART, 'Добывает из клетки 1,5\nприроста золота и самоцветов', 0, 0, 1, 2, 4, 0], 'Столяр':[STANDART, 'До 4 дерева -> до 4 досок', 4, 2, 0, 0, 0, 2], 'Печь для обжига':[STANDART, 'До 6 глины -> до 6 кирпичей', 0, 4, 2, 0, 0, 0],
              'Плавильня':[STANDART, 'До 3 дерева и 3 руды ->\nдо 3 металла', 0, 4, 2, 0, 0, 4], 'Монетный двор':[STANDART, 'До 3 золота -> до 12 монет', 0, 2, 2, 2, 0, 0], 'Мебельщик':[STANDART, 'До 4 досок -> до 2 мебели', 0, 2, 4, 2, 0, 4],
              'Гончар':[STANDART, 'До 3 глины -> до 6 керамики', 0, 2, 2, 4, 0, 2], 'Скульптор':[STANDART, '3 камня -> 1 статуя', 0, 4, 2, 2, 1, 4], 'Кузнец':[STANDART, 'До 2 дерева и 4 металла ->\nдо 4 инструментов', 0, 4, 0, 4, 1, 2],
